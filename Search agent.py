...
class BFS(Input_Path):
	...
	def jump(self,grid_point,neigbhor_point,grid1_point,neigbhor1_point):#x1y1,x2y2
		row=len(self.grid)
		col=len(self.grid[0])
	...
	def path_find(self,current):#find path
		path=[]
		while current:
			path.append(current.pos)
			current=current.p
		return(path[::-1])#path in reverse order
...
class UCS(Input_Path):
	class cost_determine:
		...
		def __gt__(self,o:object):
			return(self.cost>o.cost)#new cost greater
		def __lt__(self,o:object):
			return(self.cost<o.cost)#new cost less
		def __ge__(self,o:object):
			return(self.cost>=o.cost)#new cost greater or equal
		def __le__(self,o:object):
 			return(self.cost<=o.cost)#new cost less than or equea;
...
class astar(Input_Path):
	class cost_determine:
		...
		def __eq__(self, o: object):
			return(self.pos==o.pos)
		def __gt__(self,o:object):
			return(self.f>o.f)#new f cost greater
		def __lt__(self,o:object):
			return(self.f<o.f)#new f cost less
		def __ge__(self,o:object):
			return(self.f>=o.f)#new f cost greater than or equal
		def __le__(self,o:object):
			return(self.f<=o.f)#new f cost less than or equal
	...
	def calculate(self):
		...
		for i in self.sites_list:
			...
			for dest in dest_list:
				...
				visited=set()
				closed_list={}
				closed_list[start.pos]=0#intial cost set to 0
